...
[[pagebreak]]`;
  ...
  function isUnnumbered(idx, total) {
    if (idx == null) return true;
    return idx < 2 || idx >= total - 2;
  }
</script>
        ...
        <div class="spreads">
          {#each pages as page_html, i}
            <div class="page" style={page_style}>
              ...
              {#if !isUnnumbered(i, pages.length)}
          ...
          <div class="print-sheet">
            <div class="print-page">
              ...
              <div class="print-page-number lef">
                {#if sheet_idxs[sidx][0] != null && !isUnnumbered(sheet_idxs[sidx][0], pages.length)}
                  <div class="print-page-number lef">
                    {sheet_idxs[sidx][0] + 1}
                  </div>
                {/if}
            ...
            <div class="print-page">
              ...
              <div class="print-page-number rig">
                {#if sheet_idxs[sidx][1] != null && !isUnnumbered(sheet_idxs[sidx][1], pages.length)}
                  <div class="print-page-number rig">
                    {sheet_idxs[sidx][1] + 1}
                  </div>
                {/if}
